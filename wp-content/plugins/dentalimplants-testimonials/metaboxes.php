...
function cws_register_testimonial_metabox() {
	...
	$cmb_testimonial = new_cmb2_box( array(
		'id'           => $prefix . 'metabox',
		'title'        => __( 'Testimonial Details:', 'dentalimplants-testimonials' ),
	...
	$cmb_testimonial->add_field( array(
		'name' => __( 'Descriptor', 'dentalimplants-testimonials' ),
		'id'   => $prefix . 'descriptor',
		'type' => 'text',
		'sanitization_cb' => 'cws_cmb2_sanitize_text_callback',
	) );
	// $cmb_testimonial->add_field( array(
	// 	'name' => __( 'Company', 'dentalimplants-testimonials' ),
	// 	'id'   => $prefix . 'company',
	// 	'type' => 'text',
	// ) );
	// $cmb_testimonial->add_field( array(
	// 	'name' => __( 'Location', 'dentalimplants-testimonials' ),
	// 	'id'   => $prefix . 'location',
	// 	'type' => 'text',
	// ) );
	$cmb_testimonial->add_field( array(
		'name' => __( 'Display Excerpt', 'dentalimplants-testimonials' ),
